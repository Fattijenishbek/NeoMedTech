...
class Patient(models.Model):
    ...
    approximate_date_of_birth = models.DateField(auto_now_add=False, null=True, blank=True)

    def __str__(self):
        return f'{self.user}'

    def save(self, *args, **kwargs):
        nine_months = timedelta(days=270)

        self.approximate_date_of_birth = (
                self.date_of_pregnancy + nine_months
        )
